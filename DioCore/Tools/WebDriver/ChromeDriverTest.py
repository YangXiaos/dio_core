...
def crawlShopList(autoLogin=True):
    with ChromeDriver(ua="Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.86 Mobile Safari/537.36") as driver:
        ...
        while True:
            try:
                driver.executeJs("window.scrollBy(0, -100);")
...
def dio_testv2():
    with ChromeDriver(
        driverPath=r"C:\Users\Administrator\Downloads\chromedriver_win32\chromedriver.exe",
...
def dio_testv3():
    ...
    def modify(email, help_email, password):
        with ChromeDriver(
            ...
            driver.click('#bx_pe_3', timeLoad=1)
            driver.click('#bx_ie_1', timeLoad=1)
