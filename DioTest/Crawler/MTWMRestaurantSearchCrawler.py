...
for kwarg in kwargs:
    ...
    postData["geoType"] = "2"
    postData["cityId"] = "1"
    postData["secondCategoryId"] = ""
    postData["start"] = "0"
    postData["queryType"] = "11002"
    postData["keyword"] = kwarg["keyword"]
    postData["categoryType"] = ""
    postData["entranceId"] = "0"
    ...
    postData["wm_latitude"] = "0"
    postData["wm_longitude"] = "0"
    postData["wm_actual_latitude"] = kwarg["lat"]
    postData["wm_actual_longitude"] = kwarg["lng"]
    postData["openh5_uuid"] = "16d14d36a98c8-0e53a36f17ba0e-1a201708-1fa400-16d14d36a98c8"
    postData[
    ...
    print(downloader.post("http://i.waimai.meituan.com/openh5/search/poi", data=postData).text)
    time.sleep(3)