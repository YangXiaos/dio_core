...
if __name__ == '__main__':
    ...
    # print(file_util.readText(test_kwargs["output_file"]))



    # for row in CSVUtil.get_dict_from_csv("app_test_20190227112110_419_53.item.csv"):
    #     print(row["url"])

    # keywords = file_util.readRows("/home/changshuai/PycharmProjects/dio_core/Test/Data/yili.keyword.0314.txt")
